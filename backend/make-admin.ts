...
async function main() {
  const email = "tejas.25003273@kiet.edu"
  ...
  if (user) {
    ...
    await prisma.user.create({ data: { name: "Tejas", email, password, role: "ADMIN", isVerified: true } })
    console.log("Naya ADMIN account banaya!")
  }
  console.log("Email: tejas.25003273@kiet.edu")
